--!optimize 2
send_notification("version: 45.7", "warning")
print("HI i updated45.7")
...
send_notification("!!!NOTE:THERE MUST BE AN ITEM IN UR SECOND SLOT AND NO ITEM/AMMO PACK IN UR 3RD SLOT!!!", "warning")
